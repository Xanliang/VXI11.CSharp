...
namespace Visa32
{
    ...
    {
        public const int VI_SPEC_VERSION = 3145729;
        ...
        [DllImportAttribute("VISA32.DLL", EntryPoint = "#256", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
        public static extern int viRead(int vi, StringBuilder buffer, int count, out int retCount);
        ...
        [DllImportAttribute("VISA32.DLL", EntryPoint = "#257", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
        public static extern int viWrite(int vi, string buffer, int count, out int retCount);
